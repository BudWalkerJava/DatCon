...
@Override
 ...
 cnt_atti_00 = _payload.getUnsignedShort(118);
    ...
    protected static Signal IMU_ATTI_00IntSig = Signal
.SeriesInt("IMU_ATTI_00", "", null, Units.noUnits);
...
try {
 ...
 printCsvValue(longti_00, IMU_ATTI_00DoubleSig, "longti_00",lineT, valid);
 printCsvValue(lati_00, IMU_ATTI_00DoubleSig, "lati_00",lineT, valid);
 printCsvValue(alti_00, IMU_ATTI_00FloatSig, "alti_00",lineT, valid);
 printCsvValue(acc_x_00, IMU_ATTI_00FloatSig, "acc_x_00",lineT, valid);
 printCsvValue(acc_y_00, IMU_ATTI_00FloatSig, "acc_y_00",lineT, valid);
 printCsvValue(acc_z_00, IMU_ATTI_00FloatSig, "acc_z_00",lineT, valid);
 printCsvValue(gyro_x_00, IMU_ATTI_00FloatSig, "gyro_x_00",lineT, valid);
 printCsvValue(gyro_y_00, IMU_ATTI_00FloatSig, "gyro_y_00",lineT, valid);
 printCsvValue(gyro_z_00, IMU_ATTI_00FloatSig, "gyro_z_00",lineT, valid);
 printCsvValue(press_00, IMU_ATTI_00FloatSig, "press_00",lineT, valid);
 ...
 printCsvValue(ag_x_00, IMU_ATTI_00FloatSig, "ag_x_00",lineT, valid);
 printCsvValue(ag_y_00, IMU_ATTI_00FloatSig, "ag_y_00",lineT, valid);
 printCsvValue(ag_z_00, IMU_ATTI_00FloatSig, "ag_z_00",lineT, valid);
 printCsvValue(vg_x_00, IMU_ATTI_00FloatSig, "vg_x_00",lineT, valid);
 printCsvValue(vg_y_00, IMU_ATTI_00FloatSig, "vg_y_00",lineT, valid);
 printCsvValue(vg_z_00, IMU_ATTI_00FloatSig, "vg_z_00",lineT, valid);
 printCsvValue(gb_x_00, IMU_ATTI_00FloatSig, "gb_x_00",lineT, valid);
 printCsvValue(gb_y_00, IMU_ATTI_00FloatSig, "gb_y_00",lineT, valid);
 printCsvValue(gb_z_00, IMU_ATTI_00FloatSig, "gb_z_00",lineT, valid);
 ...
 printCsvValue(temp_x_00, IMU_ATTI_00IntSig, "temp_x_00",lineT, valid);
 printCsvValue(temp_y_00, IMU_ATTI_00IntSig, "temp_y_00",lineT, valid);
 printCsvValue(temp_z_00, IMU_ATTI_00IntSig, "temp_z_00",lineT, valid);
 printCsvValue(sensor_monitor_00, IMU_ATTI_00IntSig, "sensor_monitor_00",lineT, valid);
 printCsvValue(filter_status_00, IMU_ATTI_00IntSig, "filter_status_00",lineT, valid);
 printCsvValue(svn_00, IMU_ATTI_00IntSig, "svn_00",lineT, valid);
 printCsvValue(cnt_atti_00, IMU_ATTI_00IntSig, "cnt_atti_00",lineT, valid);
 } catch (Exception e) {
