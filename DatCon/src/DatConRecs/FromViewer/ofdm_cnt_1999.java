...
@Override
 ...
 seccuss = _payload.getUnsignedShort(8);
    ...
    protected static Signal ofdm_cntIntSig = Signal
.SeriesInt("ofdm_cnt", "", null, Units.noUnits);
    protected static Signal ofdm_cntFloatSig = Signal
.SeriesFloat("ofdm_cnt", "", null, Units.noUnits);
    protected static Signal ofdm_cntDoubleSig = Signal
.SeriesDouble("ofdm_cnt", "", null, Units.noUnits);

   public void printCols(lineType lineT) {
try {

 printCsvValue(recv_total, ofdm_cntIntSig, "recv_total",lineT, valid);
 printCsvValue(header_error, ofdm_cntIntSig, "header_error",lineT, valid);
