...
entries.add(new RecClassSpec(imu_raw_92.class,92, 30));
...
entries.add(new RecClassSpec(app_temp_cali_data_00_2198.class,2198, 84));
entries.add(new RecClassSpec(temp_cali_data_01_2196.class,2196, 84));
entries.add(new RecClassSpec(app_temp_cali_data_01_2199.class,2199, 84));
entries.add(new RecClassSpec(temp_cali_data_02_2197.class,2197, 80));
entries.add(new RecClassSpec(app_temp_cali_data_02_2200.class,2200, 80));
...
entries.add(new RecClassSpec(battery_info_17.class,17, 47));
...
entries.add(new RecClassSpec(aircraft_condition_monitor_70.class,70, 39));
