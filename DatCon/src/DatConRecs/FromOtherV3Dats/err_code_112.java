...
gcm2_act = _payload.getUnsignedByte(34);
    ...
    protected static Signal err_codeIntSig = Signal
.SeriesInt("err_code", "", null, Units.noUnits);
    protected static Signal err_codeFloatSig = Signal
.SeriesFloat("err_code", "", null, Units.noUnits);
    protected static Signal err_codeDoubleSig = Signal
.SeriesDouble("err_code", "", null, Units.noUnits);

   public void printCols(lineType lineT) {
try {

 printCsvValue(imu1_break, err_codeIntSig, "imu1_break",lineT, valid);
 printCsvValue(imu2_break, err_codeIntSig, "imu2_break",lineT, valid);
 printCsvValue(gcm0_break, err_codeIntSig, "gcm0_break",lineT, valid);
 printCsvValue(gcm1_break, err_codeIntSig, "gcm1_break",lineT, valid);
 printCsvValue(gcm2_break, err_codeIntSig, "gcm2_break",lineT, valid);
 printCsvValue(imu0_fault, err_codeIntSig, "imu0_fault",lineT, valid);
 printCsvValue(imu1_fault, err_codeIntSig, "imu1_fault",lineT, valid);
 printCsvValue(imu2_fault, err_codeIntSig, "imu2_fault",lineT, valid);
 printCsvValue(gcm0_fault, err_codeIntSig, "gcm0_fault",lineT, valid);
 printCsvValue(gcm1_fault, err_codeIntSig, "gcm1_fault",lineT, valid);
 printCsvValue(gcm2_fault, err_codeIntSig, "gcm2_fault",lineT, valid);
