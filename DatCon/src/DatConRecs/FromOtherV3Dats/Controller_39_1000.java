...
try {
 ...
 printCsvValue(ctrl_tick, ControllerIntSig, "ctrl_tick",lineT, valid);
 printCsvValue(ctrl_pitch, ControllerIntSig, "ctrl_pitch",lineT, valid);
 printCsvValue(ctrl_roll, ControllerIntSig, "ctrl_roll",lineT, valid);
 printCsvValue(ctrl_yaw, ControllerIntSig, "ctrl_yaw",lineT, valid);
 printCsvValue(ctrl_thr, ControllerIntSig, "ctrl_thr",lineT, valid);
 printCsvValue(ctrl_mode, ControllerIntSig, "ctrl_mode",lineT, valid);
 printCsvValue(mode_switch, ControllerIntSig, "mode_switch",lineT, valid);
 printCsvValue(motor_state, ControllerIntSig, "motor_state",lineT, valid);
 printCsvValue(sig_level, ControllerIntSig, "sig_level",lineT, valid);
 printCsvValue(ctrl_level, ControllerIntSig, "ctrl_level",lineT, valid);
 printCsvValue(sim_model, ControllerIntSig, "sim_model",lineT, valid);
 printCsvValue(max_height, ControllerIntSig, "max_height",lineT, valid);
 printCsvValue(max_radius, ControllerIntSig, "max_radius",lineT, valid);
 printCsvValue(D2H_x, ControllerFloatSig, "D2H_x",lineT, valid);
 printCsvValue(D2H_y, ControllerFloatSig, "D2H_y",lineT, valid);
 printCsvValue(act_req_id, ControllerIntSig, "act_req_id",lineT, valid);
 printCsvValue(act_act_id, ControllerIntSig, "act_act_id",lineT, valid);
 printCsvValue(cmd_mod, ControllerIntSig, "cmd_mod",lineT, valid);
 printCsvValue(mod_req_id, ControllerIntSig, "mod_req_id",lineT, valid);
