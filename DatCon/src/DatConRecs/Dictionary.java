...
public class Dictionary {
    //    public static HashMap<Integer, Class> entries = new HashMap<Integer, Class>();
    //    static {
    //        entries.put(Integer.valueOf(2048), Record_2048.class);
    //        entries.put(Integer.valueOf(12), GoTxt_12.class);
    //        entries.put(Integer.valueOf(17), Record_Battery_17.class);
    //        entries.put(Integer.valueOf(1), Record_1.class);
    //    }

    public static Vector<RecClassSpec> entries = new Vector<RecClassSpec>();
    static {
        entries.add(new RecClassSpec(Record_2048.class, 2048, 120));
        entries.add(new RecClassSpec(GoTxt_12.class, 12, 50, 55));
        entries.add(new RecClassSpec(RecBatt45_17.class, 17, 45));
        entries.add(new RecClassSpec(Record_1.class, 1, 120));
        entries.add(new RecClassSpec(RecFlyLog_32768.class, 0x8000, -1));
        entries.add(new RecClassSpec(Record_SDlogs_65280.class, 65280, -1));
        ...
        while (iter.hasNext()) {
            ...
            if (recClassSpec.getId() == recInDat.getId()) {
                if ((recClassSpec.lengthOK(recInDat.getLength()))
                        //                        || recClassSpec.getRecType() == RecSpec.RecType.STRING
